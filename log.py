...
def printMsg():
    if((entry_1.get()=='priti' and entry_2.get()=='844') or (entry_1.get()=='ganesh' and entry_2.get()=='844') or (entry_1.get()=='ayush' and entry_2.get()=='844') ):
...
def createWindow():
    ...
    def Cancellation():
        ...
        cancel = Label(window4, text="PNR NO", font=('Slab Serif', 15), bg="purple", fg="white").place(x=100, y=150, width=90)
